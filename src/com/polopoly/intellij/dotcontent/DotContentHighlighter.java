...
public class DotContentHighlighter extends SyntaxHighlighterBase
{
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(DotContentTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(DotContentTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(DotContentTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(DotContentTypes.COMMENT)) {
            return COMMENT_KEYS;
